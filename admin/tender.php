			...
			<div class="row">
				...
				<div class="col-md-9 nopadding">
					...
					<div class="tab-pane fade in panel-body" id="newsupdates" >
							<label>List of tender:</label>
							<form action="admin_tender.php" id="newsupdates_form" method="post" style="display:inline;">
							<div class="panel" style="padding:0 10px;">

						
							<?php
							$query="SELECT * FROM tender ORDER BY id DESC;";
							...
							<form action="admin_tender.php" method="post" onsubmit="return checknewsupdates()" enctype="multipart/form-data" >
							<input type="hidden" name="form_type" value="newsupdates">
							...
							<form action="admin_tender.php" method="post" onsubmit="return checkeditnewsupdates()" enctype="multipart/form-data" >
							<input type="hidden" name="form_type" value="newsupdates">
