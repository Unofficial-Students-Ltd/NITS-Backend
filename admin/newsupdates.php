				...
				<div class="col-md-9 nopadding">
					...
					<?php require("connection.php");?>
						...
						<div class="tab-pane fade in panel-body" id="newsupdates" >
							<label>List of news updates:</label>
							<form action="admin_submitcontent.php" id="newsupdates_form" method="post" style="display:inline;">
							<div class="panel" style="padding:0 10px;">

							<?php
							$query="SELECT * FROM newsupdates ORDER BY id DESC;";
							...
							<form action="admin_submitcontent.php" method="post" onsubmit="return checknewsupdates()" enctype="multipart/form-data" >
							<input type="hidden" name="form_type" value="newsupdates">
							...
							<form action="admin_submitcontent.php" method="post" onsubmit="return checkeditnewsupdates()" enctype="multipart/form-data" >
							<input type="hidden" name="form_type" value="newsupdates">
