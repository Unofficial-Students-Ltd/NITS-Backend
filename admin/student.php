				...
				<div class="col-md-9 nopadding">
					...
					<?php require("connection.php");?>
						...
						<div class="tab-pane fade in panel-body" id="newsupdates" >
							<label>List of Student Corner:</label>
							<form action="admin_content.php" id="newsupdates_form" method="post" style="display:inline;">
							...
							<form action="admin_content.php" method="post" onsubmit="return checknewsupdates()" enctype="multipart/form-data" >
							<input type="hidden" name="form_type" value="newsupdates">
							...
							<form action="admin_content.php" method="post" onsubmit="return checkeditnewsupdates()" enctype="multipart/form-data" >
							<input type="hidden" name="form_type" value="newsupdates">
