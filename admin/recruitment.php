			...
			<div class="row">
				...
				<div class="col-md-9 nopadding">
					...
					<div class="tab-pane fade in panel-body" id="newsupdates" >
							<label>List of recruitment:</label>
							<form action="admin_recruitment.php" id="newsupdates_form" method="post" style="display:inline;">
							...
							<form action="admin_recruitment.php" method="post" onsubmit="return checknewsupdates()" enctype="multipart/form-data" >
							<input type="hidden" name="form_type" value="newsupdates">
							...
							<form action="admin_recruitment.php" method="post" onsubmit="return checkeditnewsupdates()" enctype="multipart/form-data" >
							<input type="hidden" name="form_type" value="newsupdates">
